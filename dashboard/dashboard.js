...
async function pair() {
  ...
  if (!encoded) {
    ...
    setStatus('COGITATOR LINK LOST', 'interrupted');
    setText('[data-link-quality]', 'PAIRING REQUIRED');
