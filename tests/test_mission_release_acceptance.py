...
"""
    ...
    def test_release_assets_versions_and_mission_scope_are_consistent(self):
        ...
        self.assertIn("const APP_VERSION = '6.4.11'", app)
        self.assertIn("const APP_VERSION = '6.4.11'", worker)
        self.assertIn("V6.4.11", index)
        for asset in ("app.js", "mission-engine.js", "persistence.js", "styles.css"):
            self.assertIn(f"{asset}?v=6.4.11", index)
        for asset in (
