...
class V800NpoMultiActionActivationTests(unittest.TestCase):
    ...
    def test_18_movement_yes_is_affirmative(self):
        self.assertIn('Reposition to gain a valid unobscured target or better win the mission.', APP)
    ...
    def test_40_version_800_everywhere(self):
        self.assertIn("const APP_VERSION = '8.0.0';", APP); self.assertIn("const APP_VERSION = '8.0.0';", WORKER)
        self.assertIn('V8.0.0', INDEX); self.assertTrue(README.startswith('# Tomb World Solo Guide v8.0.0'))
