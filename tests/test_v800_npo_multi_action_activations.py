...
class V800NpoMultiActionActivationTests(unittest.TestCase):
    ...
    def test_40_version_800_everywhere(self):
        self.assertIn("const APP_VERSION = '8.7.0';", APP); self.assertIn("const APP_VERSION = '8.7.0';", WORKER)
        self.assertIn('V8.7.0', INDEX); self.assertTrue(README.startswith('# Tomb World Solo Guide v8.7.0'))
