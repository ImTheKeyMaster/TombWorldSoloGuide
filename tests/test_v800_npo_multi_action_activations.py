...
class V800NpoMultiActionActivationTests(unittest.TestCase):
    ...
    def test_40_version_800_everywhere(self):
        self.assertIn("const APP_VERSION = '8.6.58';", APP); self.assertIn("const APP_VERSION = '8.6.58';", WORKER)
        self.assertIn('V8.6.58', INDEX); self.assertTrue(README.startswith('# Tomb World Solo Guide v8.6.58'))
