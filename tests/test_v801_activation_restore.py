...
const nodes=new Map();
function element(){return {hidden:false,disabled:false,open:false,innerHTML:'',style:{},dataset:{},classList:{add(){},remove(){},toggle(){}},addEventListener(){},querySelector(){return element()},querySelectorAll(){return []},setAttribute(){},removeAttribute(){},toggleAttribute(){},showModal(){this.open=true},close(){this.open=false}};}
