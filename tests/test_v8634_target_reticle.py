...
class TargetReticleTests(unittest.TestCase):
    ...
    def test_release_version_is_current_and_save_version_is_unchanged(self):
        ...
        self.assertIn("const APP_VERSION = '8.6.47';", SERVICE_WORKER)
        self.assertIn('<div class="version">V8.6.47</div>', INDEX)
        self.assertIn("# Tomb World Solo Guide v8.6.47", README)
