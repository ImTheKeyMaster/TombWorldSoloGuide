...
class DeadlyEncounterIntegration(unittest.TestCase):
    ...
    def test_release_version_and_precache(self):
        self.assertTrue(README.startswith('# Tomb World Solo Guide v7.5.1'));self.assertIn('## v7.5.1',README)
        self.assertIn("const APP_VERSION = '7.5.1';",APP);self.assertIn("const APP_VERSION = '7.5.1';",WORKER);self.assertIn('V7.5.1',INDEX)
