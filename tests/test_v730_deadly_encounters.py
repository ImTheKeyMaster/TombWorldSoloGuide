...
class DeadlyEncounterIntegration(unittest.TestCase):
    ...
    def test_release_version_and_precache(self):
        self.assertTrue(README.startswith('# Tomb World Solo Guide v8.0.1'));self.assertIn('## v8.0.1',README)
        self.assertIn("const APP_VERSION = '8.0.1';",APP);self.assertIn("const APP_VERSION = '8.0.1';",WORKER);self.assertIn('V8.0.1',INDEX)
