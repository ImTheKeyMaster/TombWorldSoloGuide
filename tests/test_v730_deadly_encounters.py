...
class DeadlyEncounterIntegration(unittest.TestCase):
    ...
    def test_release_version_and_precache(self):
        self.assertTrue(README.startswith('# Tomb World Solo Guide v8.4.0'));self.assertIn('## v8.4.0',README)
        self.assertIn("const APP_VERSION = '8.4.0';",APP);self.assertIn("const APP_VERSION = '8.4.0';",WORKER);self.assertIn('V8.4.0',INDEX)
