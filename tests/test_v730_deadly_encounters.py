...
class DeadlyEncounterIntegration(unittest.TestCase):
    ...
    def test_release_version_and_precache(self):
        self.assertTrue(README.startswith('# Tomb World Solo Guide v7.6.0'));self.assertIn('## v7.6.0',README)
        self.assertIn("const APP_VERSION = '7.6.0';",APP);self.assertIn("const APP_VERSION = '7.6.0';",WORKER);self.assertIn('V7.6.0',INDEX)
