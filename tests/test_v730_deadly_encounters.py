...
class DeadlyEncounterIntegration(unittest.TestCase):
    ...
    def test_release_version_and_precache(self):
        self.assertTrue(README.startswith('# Tomb World Solo Guide v7.5.9'));self.assertIn('## v7.5.9',README)
        self.assertIn("const APP_VERSION = '7.5.9';",APP);self.assertIn("const APP_VERSION = '7.5.9';",WORKER);self.assertIn('V7.5.9',INDEX)
