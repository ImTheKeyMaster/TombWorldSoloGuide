...
class MyWillBeDoneExplanationTests(unittest.TestCase):
    ...
    def test_release_version_is_consistent_without_save_schema_change(self):
        ...
        self.assertIn("const APP_VERSION = '8.6.48';", (ROOT / "service-worker.js").read_text())
        self.assertIn('<div class="version">V8.6.48</div>', (ROOT / "index.html").read_text())
        self.assertTrue((ROOT / "README.md").read_text().startswith('# Tomb World Solo Guide v8.6.48'))
