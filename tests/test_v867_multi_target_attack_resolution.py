...
class MultiTargetAttackResolutionTests(unittest.TestCase):
    ...
    def test_09_npo_torrent_secondaries(self): self.assert_app("input.checked=sameStep?(saved.secondaryTargetIds||[]).includes(input.value):false")
    ...
    def test_17_separate_defense_dice(self): self.assert_app("requestDefenseDice(defenseCount")
    ...
    def test_21_banishment_per_target(self): self.assert_app("requestDimensionalBanishment(combat")
