...
""")
    ...
    def test_cogitator_polish_is_lightweight_and_mobile_safe(self):
        ...
        self.assertIn("max-height:calc(100dvh", dialog_rule)
        ...
        self.assertIn("max-height:min(450px,50dvh,calc(100dvh - 300px - env(safe-area-inset-top) - env(safe-area-inset-bottom)))", body_rule)
        ...
        self.assertIn("max-height:calc(100dvh", mobile_dialog_rule)
        self.assertIn("max-height:min(48dvh,calc(100dvh - 300px - env(safe-area-inset-top) - env(safe-area-inset-bottom)))", mobile_rule)
