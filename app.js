...
document.addEventListener('touchend',function(e){
  ...
  function setupContent(stepId){
    ...
    if(stepId==='options'){
      ...
      const deadlyOption=isPvpMode()?'<div class="check-row deadly-encounters-option pvp-unavailable-option"><span><strong>Deadly Encounters: Tomb Worlds (Solo battles only)</strong></span></div>'
