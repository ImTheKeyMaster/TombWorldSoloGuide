...
document.addEventListener('touchend',function(e){
  ...
  const eventDefinitions = {
    ...
    'maze-reforms':{title:'The Maze Reforms',text:'The Guide automatically rolls D3 to determine how many open hatchways can be closed, up to that result. Close one breach and that many open hatchways. If this cannot be resolved, draw another event card.',execution:{type:'maze-reforms'},duration:'immediate',redrawIfImpossible:true},
