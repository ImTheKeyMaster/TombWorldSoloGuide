...
const PRECACHE_ASSETS = [
  './', APP_SHELL, `./app.js?v=${APP_VERSION}`, `./mission-engine.js?v=${APP_VERSION}`, `./persistence.js?v=${APP_VERSION}`, `./styles.css?v=${APP_VERSION}`,
  ...
  './Missions/mission.schema.json', './Missions/definition-01-shifting-labyrinth.json', './Missions/definition-04-destroy-sarcophagus.json',
